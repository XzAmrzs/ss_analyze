...
spark-submit --jars external/spark-streaming-kafka-assembly_2.10-1.6.0.jar --master spark://$HOSTNAME:7077 --executor-memory 2000M --conf spark.streaming.backpressure.enabled=true --conf spark.streaming.receiver.maxrateperpartition=3800 run.py
